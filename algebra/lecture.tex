...
\begin{document}
    ...
    \begin{definition}
        ...
        \in V$ -- это\\ $\tab[3.6cm]\{\lambda_1a_1 + \lambda_2a_ + ... + 
    ...
    \begin{theorem}
        ...
        \begin{enumerate}
            ...
            \item $\exists$ базис в $V$, в котором $A_\varphi$
            диагональна.
            \item В $V\ \exists$ собственный базис для $\varphi$.
            \item Все характеритические корни $\lambda_j \in F
            \ (\lambda_1,...,\lambda_s - \text{все различные})$
            \\$\forall j = 1,...,s:\ dimV_{\lambda_j} = 
            \text{алг}(\lambda_j)$
    ...
    \begin{proof}
        ...
        \end{cases} \Longrightarrow \langle X_1, Y_1\rangle$ 
