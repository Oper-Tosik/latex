...
\begin{document}
    ...
    \begin{proof}
        ...
        подпространствами $R_i$.\\
        $\tab[1.2cm]d$  $\tab[1.9cm]d-1$ $\tab[3.5cm]2$
        $\tab[2.8cm]1$\\
        \begin{tabular}{ |c|c|c|c|c| }
            \hline
            $e_1^{(1)}...\ e_{p_1}^{(1)}$ &
            $e_{p_1 + 1}^{(1)}...\ e_{p_1 + p_2}^{(1)}$ &
            $\dots$ &
            $e_{p_{d-2} + 1}^{(1)}...\ e_{p_{d-1}}^{(1)}$ &
            $e_{p_{d-1} + 1}^{(1)}...\ e_r^{(1)}$\\
            \hline
        \end{tabular}\\
        $\tab[0.8cm]R_{d-1}\tab[1cm]R_{d-2}/R_{d-1}
        \tab[2.5cm]R_1 / R_2\tab[2cm]V_0 / R_1$ \\$\\$
