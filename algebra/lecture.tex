...
\begin{document}
    ...
    \begin{proof}
        ...
        q_1(\varphi) + ... + q_s(\varphi)  = \varepsilon \Longrightarrow
        \forall v \in V$ имеем разложение:
        $\varepsilon v = v = q_1(\varphi)v +...+q_s(\varphi)v$ --
        ...
        \Longrightarrow V = K_{\lambda_1} +...+K_{\lambda_s}$$
        Многочлены от одного оператора между собой
        коммутируют\\ На самом деле $K_{\lambda_i} \subseteq
        Ker(\varphi - \lambda_i \varepsilon)^{k_i}$\\
        Допустим, что $\exists w \in K_{\lambda_i},\ 
        ...
        K_{\lambda_i} = Ker(\varphi - \lambda_i \varepsilon)^{k_i}$
        и $dimK_{\lambda_i} = k_i$\\
        $K_{\lambda_i}$ - инвариантные, т.к. $K_{\lambda_i} = 
